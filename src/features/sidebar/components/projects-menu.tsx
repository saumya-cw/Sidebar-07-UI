...
export function ProjectsMenu({ isCollapsed = false }: { isCollapsed?: boolean }) {
                  ...
                  <MenuRoot>
                    <MenuTrigger asChild>
                      <Button
                        ...
                        className="inline-flex size-8 shrink-0 items-center justify-center rounded-md text-zinc-700 opacity-0 transition-opacity hover:bg-zinc-100 focus:opacity-100 focus:outline-none focus-visible:opacity-100 group-hover:opacity-100 group-focus-within:opacity-100"
                      >
